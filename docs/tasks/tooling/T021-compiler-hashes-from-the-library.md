...
- `e.algo.hash`: `scripts/algos/decisions-pending.md`×4†, `src/artifact_hash.e`×3, `lib/e/algo/sketch.e`×2†, `scripts/algos/batch35.json`×2, `lib/e/algo/consistent_hash.e`×1, `lib/e/algo/uuid.e`×1, `lib/e/db/storage.e`×1†, `lib/e/fmt/gzip.e`×1
