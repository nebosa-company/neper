...
| score | 0.40 of 1 |
| queue position | 53 of 55 (only position 1 is eligible for the next session; see README) |
...
- `e.algo.hash`: `src/artifact_hash.e`×3, `lib/e/algo/uuid.e`×1, `lib/e/fmt/gzip.e`×1, `lib/e/fmt/zip.e`×1, `src/lower.e`×1‡
...
- `crc32c`: `src/artifact_hash.e`×3, `src/em.e`×3‡, `src/main.e`×3‡, `src/runtime_elf_x64.s`×3†, `src/runtime_pe_x64.asm`×3†, `benchmarks/fuzz/fuzz.py`×2, `src/check.e`×2‡, `src/runtime_elf_x64.e`×2
