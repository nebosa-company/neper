...
- `e.algo.hash`: `src/artifact_hash.e`×3, `scripts/render_tasks.py`×2†, `lib/e/algo/uuid.e`×1, `lib/e/fmt/gzip.e`×1, `lib/e/fmt/zip.e`×1, `src/lower.e`×1‡
...
- `lib/e/crypto/hash.e`: `scripts/render_tasks.py`×1†
