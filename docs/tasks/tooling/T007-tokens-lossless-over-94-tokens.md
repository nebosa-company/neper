...
| score | 0.95 of 1 |
| queue position | 36 of 48 (only position 1 is eligible for the next session; see README) |
...
- `INVALID`: `lib/e/os.windows.e`×17‡, `tests/conformance/tokens/hostile.expected.jsonl`×7, `lib/e/ui/control.e`×4‡, `lib/e/ui/accessibility.e`×2, `src/tool.e`×2‡
