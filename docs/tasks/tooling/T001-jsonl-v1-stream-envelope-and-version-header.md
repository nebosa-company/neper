...
- `emit-executable`: `src/main.e`×9‡, `benchmarks/baseline/results/baseline-linux.json`×8, `benchmarks/baseline/results/baseline-windows.json`×8, `benchmarks/baseline/h01-windows-d351.json`×6, `benchmarks/baseline/h29-windows-d382.json`×6, `benchmarks/baseline/h29-windows-d384.json`×4, `benchmarks/baseline/h29-windows-d386.json`×4, `benchmarks/baseline/h29-windows-d387.json`×4
