...
- `instantiate`: `src/check.e`×18‡, `src/lower.e`×4‡, `src/em.e`×2‡, `tests/conformance/tools/index_unsafe.expected.jsonl`×2, `src/tool.e`×1‡, `tests/conformance/reject/safety_copy_toolchain.e`×1, `tests/conformance/tools/explain.e`×1
