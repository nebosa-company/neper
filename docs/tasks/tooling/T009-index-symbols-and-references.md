...
- `instantiate`: `src/check.e`×19‡, `lib/e/algo/egraph.e`×5, `src/lower.e`×4‡, `src/em.e`×2‡, `tests/conformance/tools/index_unsafe.expected.jsonl`×2, `scripts/algos/decisions-pending.md`×1†, `src/tool.e`×1‡, `tests/conformance/reject/safety_copy_toolchain.e`×1
