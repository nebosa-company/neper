...
- `e.os`: `tests/conformance/tools/explain_inline.x64-linux.expected.jsonl`×138, `tests/conformance/tools/explain_inline.x64-windows.expected.jsonl`×131, `src/resolve.e`×36†, `lib/e/os.linux.e`×8‡, `src/check.e`×8‡, `lib/e/fs.e`×7, `lib/e/os.windows.e`×6‡, `lib/e/proc.e`×6
