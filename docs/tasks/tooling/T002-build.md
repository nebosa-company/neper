...
| score | 0.85 of 1 |
| queue position | 29 of 46 (only position 1 is eligible for the next session; see README) |
...
- `.exe`: `benchmarks/baseline/results/baseline-windows.json`×9, `benchmarks/baseline/results/h25-windows-d936.json`×9, `benchmarks/baseline/h01-windows-d351.json`×7, `benchmarks/baseline/h29-windows-d382.json`×7, `benchmarks/baseline/h29-windows-d384.json`×5, `benchmarks/baseline/h29-windows-d386.json`×5, `benchmarks/baseline/h29-windows-d387.json`×5, `benchmarks/baseline/h29-windows-d390.json`×5
- `build-manifest`: `src/main.e`×8‡, `src/tool.e`×7‡, `benchmarks/baseline/edit.py`×1, `tests/conformance/tools/manifest.e`×1, `tests/conformance/tools/manifest.x64-linux.expected.jsonl`×1, `tests/conformance/tools/manifest.x64-windows.expected.jsonl`×1, `tests/conformance/tools/manifest_map.x64-linux.expected.jsonl`×1, `tests/conformance/tools/manifest_map.x64-windows.expected.jsonl`×1
