# P3-02 — Property editing (2 components)

| field | value |
|---|---|
| phase | P3 — Productivity controls |
| module | `e.ui.collection` |
| module surface | `partial`, layer 6, deps `e.gfx.geometry`, `e.gfx.paint`, `e.mem`, `e.ui.accessibility`, `e.ui.control`, `e.ui.input`, `e.ui.layout`, `e.ui.style`, `e.ui.widget` |
| blocked by | `P2` |
| delivered | 0 of 2 |
...
- [ ] `PropertyGrid`
  - `docs/widget-library-proposal.md:310` | `PropertyGrid`, `KeyValueEditor` | categorized editable properties, validation and reset actions |
- [ ] `KeyValueEditor`
  - `docs/widget-library-proposal.md:310` | `PropertyGrid`, `KeyValueEditor` | categorized editable properties, validation and reset actions |
