# P1-14 — Basic transient UI (3 components)
...
- [ ] `Tooltip`
  - `docs/widget-library-proposal.md:168` | `Tooltip` | hover, focus and long-press activation |
- [ ] `Menu`
...
- [ ] `AlertDialog`
  ...
  - `docs/widget-library-proposal.md:325` - `MessageBox` and `InputDialog` are convenience builders over `AlertDialog` and
