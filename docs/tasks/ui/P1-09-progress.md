...
- [ ] `ProgressBar`
  - `docs/widget-library-proposal.md:166` | `ProgressBar`, `ProgressRing` | determinate and indeterminate; reduced-motion behavior |
- [ ] `ProgressRing`
  - `docs/widget-library-proposal.md:166` | `ProgressBar`, `ProgressRing` | determinate and indeterminate; reduced-motion behavior |
  - `docs/widget-library-proposal.md:323` - `Label` is `Text`; `ActivityIndicator` is an indeterminate `ProgressRing`;
