# P1-13 — Disclosure and panes (6 components)
...
- [ ] `Expander`
  - `docs/widget-library-proposal.md:173` | `Disclosure`, `Expander`, `Accordion` | keyboard-operable expanded state |
- [ ] `Tabs`
  - `docs/widget-library-proposal.md:209` | `Tabs`, `TabView` | peer destinations or document views |
  - `docs/widget-library-proposal.md:210` | `DocumentTabs` | closeable/reorderable documents with dirty and pinned states |
- [ ] `TabView`
  - `docs/widget-library-proposal.md:209` | `Tabs`, `TabView` | peer destinations or document views |
- [ ] `SplitView`
  - `docs/widget-library-proposal.md:106` | `SplitView`, `ResizablePane` | pointer/keyboard-resizable desktop and tablet panes |
- [ ] `ResizablePane`
  - `docs/widget-library-proposal.md:106` | `SplitView`, `ResizablePane` | pointer/keyboard-resizable desktop and tablet panes |
