# P4-09 — Shell file operations (3 components)
...
- [ ] `OpenUri`
  - `docs/widget-library-proposal.md:290` | `OpenUri`, `RevealInFileManager`, `MoveToTrash` | delegate URI opening, file reveal and recoverable deletion to the host shell |
- [ ] `RevealInFileManager`
  - `docs/widget-library-proposal.md:290` | `OpenUri`, `RevealInFileManager`, `MoveToTrash` | delegate URI opening, file reveal and recoverable deletion to the host shell |
- [ ] `MoveToTrash`
  - `docs/widget-library-proposal.md:290` | `OpenUri`, `RevealInFileManager`, `MoveToTrash` | delegate URI opening, file reveal and recoverable deletion to the host shell |
