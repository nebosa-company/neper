...
- [ ] `Wizard`
  - `docs/widget-library-proposal.md:215` | `Wizard` | explicit ordered steps with validation and back/next actions |
- [ ] `WindowSwitcher`
  - `docs/widget-library-proposal.md:216` | `WindowSwitcher` | application-owned selection among open windows/documents |
- [ ] `CommandPalette`
  - `docs/widget-library-proposal.md:217` | `CommandPalette` | searchable application commands; phase 3 composite |
