...
- [ ] `MenuBar`
  - `docs/widget-library-proposal.md:208` | `MenuBar`, `Menu`, `ContextMenu` | desktop and pointer/keyboard commands |
- [ ] `ContextMenu`
  - `docs/widget-library-proposal.md:208` | `MenuBar`, `Menu`, `ContextMenu` | desktop and pointer/keyboard commands |
  - `docs/widget-library-proposal.md:234` | `Menu`, `ContextMenu` | nested keyboard navigation, type-ahead and checked items |
- [ ] `NavigationSplit`
  - `docs/widget-library-proposal.md:212` | `NavigationSplit` | master-detail and two/three-column layouts |
- [ ] `NavigationDrawer`
  - `docs/widget-library-proposal.md:213` | `NavigationDrawer`, `NavigationRail`, `BottomNavigation` | equivalent top-level destinations at different widths |
- [ ] `NavigationRail`
  - `docs/widget-library-proposal.md:213` | `NavigationDrawer`, `NavigationRail`, `BottomNavigation` | equivalent top-level destinations at different widths |
- [ ] `BottomNavigation`
  - `docs/widget-library-proposal.md:213` | `NavigationDrawer`, `NavigationRail`, `BottomNavigation` | equivalent top-level destinations at different widths |
- [ ] `Breadcrumbs`
  - `docs/widget-library-proposal.md:214` | `Breadcrumbs`, `Sidebar` | hierarchical desktop/tablet navigation |
- [ ] `Sidebar`
  - `docs/widget-library-proposal.md:214` | `Breadcrumbs`, `Sidebar` | hierarchical desktop/tablet navigation |
