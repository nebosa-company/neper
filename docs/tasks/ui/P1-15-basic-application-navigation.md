# P1-15 — Basic application navigation (5 components)
...
- [ ] `AppBar`
  - `docs/widget-library-proposal.md:207` | `AppBar`, `Toolbar`, `StatusBar` | window/page actions and status |
- [ ] `Toolbar`
  - `docs/widget-library-proposal.md:207` | `AppBar`, `Toolbar`, `StatusBar` | window/page actions and status |
- [ ] `StatusBar`
  - `docs/widget-library-proposal.md:207` | `AppBar`, `Toolbar`, `StatusBar` | window/page actions and status |
