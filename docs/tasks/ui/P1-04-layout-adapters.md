# P1-04 — Layout adapters (8 components)
...
- [ ] `Align`
  - `docs/widget-library-proposal.md:102` | `Align`, `Center`, `Padding`, `Spacer` | allocation-free convenience constructors |
- [ ] `Center`
  - `docs/widget-library-proposal.md:102` | `Align`, `Center`, `Padding`, `Spacer` | allocation-free convenience constructors |
...
- [ ] `Spacer`
  - `docs/widget-library-proposal.md:102` | `Align`, `Center`, `Padding`, `Spacer` | allocation-free convenience constructors |
- [ ] `Constrained`
  - `docs/widget-library-proposal.md:103` | `Constrained`, `AspectRatio`, `Fitted` | deterministic constraint adapters |
- [ ] `AspectRatio`
  - `docs/widget-library-proposal.md:103` | `Constrained`, `AspectRatio`, `Fitted` | deterministic constraint adapters |
- [ ] `Fitted`
  - `docs/widget-library-proposal.md:103` | `Constrained`, `AspectRatio`, `Fitted` | deterministic constraint adapters |
- [ ] `Responsive`
  - `docs/widget-library-proposal.md:108` | `Responsive` | choose a child from caller-declared size/capability breakpoints |
  - `docs/widget-library-proposal.md:111` primitives. `Responsive` must use measured constraints, never a hard-coded
