# P2-01 — Advanced actions (5 components)
...
- [ ] `SplitButton`
  - `docs/widget-library-proposal.md:120` | `SplitButton`, `MenuButton` | primary action plus menu or menu-only action |
- [ ] `MenuButton`
  - `docs/widget-library-proposal.md:120` | `SplitButton`, `MenuButton` | primary action plus menu or menu-only action |
- [ ] `SpeedDial`
  - `docs/widget-library-proposal.md:121` | `SpeedDial` | composite floating action that expands a short action list |
  - `docs/widget-library-proposal.md:324` - `FloatingActionButton` is a `Button` variant and its expanded form is `SpeedDial`;
- [ ] `Chip`
  - `docs/widget-library-proposal.md:127` | `Chip` | assist, filter, input and suggestion behavior as variants |
- [ ] `Rating`
  - `docs/widget-library-proposal.md:131` | `Rating` | discrete value input; composite over selection primitives |
