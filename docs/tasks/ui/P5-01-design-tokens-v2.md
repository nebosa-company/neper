# P5-01 — Design tokens v2 (8 components)

| field | value |
|---|---|
| phase | P5 — Neper UI v2 design language (docs/ux) |
| module | `e.ui.style` |
| module surface | `partial`, layer 2, deps `e.gfx.geometry`, `e.gfx.paint` |
| blocked by | `P4` |
| delivered | 0 of 8 |
