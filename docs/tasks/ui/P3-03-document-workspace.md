# P3-03 — Document workspace (4 components)
...
- [ ] `DocumentTabs`
  - `docs/widget-library-proposal.md:210` | `DocumentTabs` | closeable/reorderable documents with dirty and pinned states |
- [ ] `DockLayout`
...
- [ ] `MultiDocumentWorkspace`
  - `docs/widget-library-proposal.md:312` | `MultiDocumentWorkspace` | document tabs, window switching and close/save coordination |
