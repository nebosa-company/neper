# P2-11 — Content manipulation (4 components)
...
- [ ] `ZoomView`
  - `docs/widget-library-proposal.md:105` | `ZoomView` | bounded pan/zoom viewport for images, diagrams and custom content |
- [ ] `DragSource`
  - `docs/widget-library-proposal.md:286` | `SystemDragSource`, `SystemDropTarget`, `DragOperation`, `PromisedFile` | cross-process and desktop drag/drop for files, directories, text
  - `docs/widget-library-proposal.md:297` Likewise, phase-2 `DragSource`, `DropTarget` and `ClipboardCommands` are widget
- [ ] `DropTarget`
  - `docs/widget-library-proposal.md:286` | `SystemDragSource`, `SystemDropTarget`, `DragOperation`, `PromisedFile` | cross-process and desktop drag/drop for files, directories, text
  - `docs/widget-library-proposal.md:297` Likewise, phase-2 `DragSource`, `DropTarget` and `ClipboardCommands` are widget
- [ ] `ClipboardCommands`
