# P2-07 — Collection interaction (3 components)
...
- [ ] `ReorderableList`
  - `docs/widget-library-proposal.md:190` | `ReorderableList` | drag/keyboard reorder with explicit move action |
- [ ] `PullToRefresh`
  - `docs/widget-library-proposal.md:191` | `PullToRefresh`, `SwipeActions` | touch collection behaviors with keyboard/action alternatives |
  - `docs/widget-library-proposal.md:329` - a refresh indicator is the presentation used by `PullToRefresh`;
- [ ] `SwipeActions`
  - `docs/widget-library-proposal.md:191` | `PullToRefresh`, `SwipeActions` | touch collection behaviors with keyboard/action alternatives |
