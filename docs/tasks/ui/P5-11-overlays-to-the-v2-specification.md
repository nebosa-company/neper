# P5-11 — Overlays to the v2 specification (11 components)

| field | value |
|---|---|
| phase | P5 — Neper UI v2 design language (docs/ux) |
| module | `e.ui.overlay` |
| module surface | `partial`, layer 6, deps `e.gfx.geometry`, `e.gfx.paint`, `e.mem`, `e.time`, `e.ui.accessibility`, `e.ui.control`, `e.ui.layout`, `e.ui.style`, `e.ui.widget` |
| blocked by | `P4` |
| delivered | 0 of 11 |
