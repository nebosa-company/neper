# P1-10 — Text fields (4 components)
...
- [ ] `TextField`
  ...
  - `docs/widget-library-proposal.md:143` | `TextField`, `PasswordField`, `SearchField` | single-line edit, IME, selection, undo, validation state |
- [ ] `PasswordField`
  - `docs/widget-library-proposal.md:143` | `TextField`, `PasswordField`, `SearchField` | single-line edit, IME, selection, undo, validation state |
- [ ] `SearchField`
  - `docs/widget-library-proposal.md:143` | `TextField`, `PasswordField`, `SearchField` | single-line edit, IME, selection, undo, validation state |
- [ ] `TextArea`
  - `docs/widget-library-proposal.md:144` | `TextArea` | multiline edit, scrolling, line and selection navigation |
