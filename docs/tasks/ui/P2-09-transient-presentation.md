# P2-09 — Transient presentation (7 components)

| field | value |
|---|---|
| phase | P2 — Scalable application UI |
| module | `e.ui.overlay` |
| module surface | `partial`, layer 6, deps `e.gfx.geometry`, `e.gfx.paint`, `e.mem`, `e.ui.accessibility`, `e.ui.control`, `e.ui.layout`, `e.ui.style`, `e.ui.widget` |
| blocked by | `P1` |
| delivered | 0 of 7 |
...
- [ ] `Popup`
  - `docs/widget-library-proposal.md:231` | `Popup`, `Popover`, `Flyout` | anchored placement, flip/shift, dismissal and focus return |
- [ ] `Popover`
  - `docs/widget-library-proposal.md:231` | `Popup`, `Popover`, `Flyout` | anchored placement, flip/shift, dismissal and focus return |
- [ ] `Flyout`
  - `docs/widget-library-proposal.md:231` | `Popup`, `Popover`, `Flyout` | anchored placement, flip/shift, dismissal and focus return |
- [ ] `Dialog`
  - `docs/widget-library-proposal.md:232` | `Dialog`, `AlertDialog` | modal focus scope, default/cancel/destructive actions |
  - `docs/widget-library-proposal.md:288` | `OpenFileDialog`, `SaveFileDialog`, `FolderDialog`, `DocumentGrant`, `RecentDocuments` | native file/folder selection, filters, multi-sele
- [ ] `Sheet`
  - `docs/widget-library-proposal.md:233` | `Sheet`, `BottomSheet`, `ActionSheet` | adaptive modal/nonmodal presentation and drag dismissal |
  - `docs/widget-library-proposal.md:287` | `SystemClipboard`, `ClipboardMonitor`, `ShareSheet`, `ShareTarget` | typed multi-representation clipboard and operating-system share send/
- [ ] `BottomSheet`
  - `docs/widget-library-proposal.md:233` | `Sheet`, `BottomSheet`, `ActionSheet` | adaptive modal/nonmodal presentation and drag dismissal |
- [ ] `ActionSheet`
  - `docs/widget-library-proposal.md:233` | `Sheet`, `BottomSheet`, `ActionSheet` | adaptive modal/nonmodal presentation and drag dismissal |
