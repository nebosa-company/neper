# P4-04 — Typed host data exchange (4 components)
...
- [ ] `ContentType`
  - `docs/widget-library-proposal.md:285` | `ContentType`, `DataOffer`, `DataRepresentation`, `DataProvider` | one typed, lazy/async data-transfer model mapped to MIME, UTI and nativ
- [ ] `DataOffer`
  - `docs/widget-library-proposal.md:285` | `ContentType`, `DataOffer`, `DataRepresentation`, `DataProvider` | one typed, lazy/async data-transfer model mapped to MIME, UTI and nativ
- [ ] `DataRepresentation`
  - `docs/widget-library-proposal.md:285` | `ContentType`, `DataOffer`, `DataRepresentation`, `DataProvider` | one typed, lazy/async data-transfer model mapped to MIME, UTI and nativ
