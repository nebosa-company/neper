# P4-08 — Activation and associations (5 components)
...
| blocked by | `P3`, `native-activation-api` |
| delivered | 0 of 5 |
...
- [ ] `ActivationEvent`
  - `docs/widget-library-proposal.md:289` | `ActivationEvent`, `FileAssociation`, `ProtocolAssociation`, `StartupRegistration`, `SingleInstanceActivation` | declarative package regis
- [ ] `FileAssociation`
  - `docs/widget-library-proposal.md:289` | `ActivationEvent`, `FileAssociation`, `ProtocolAssociation`, `StartupRegistration`, `SingleInstanceActivation` | declarative package regis
- [ ] `ProtocolAssociation`
  - `docs/widget-library-proposal.md:289` | `ActivationEvent`, `FileAssociation`, `ProtocolAssociation`, `StartupRegistration`, `SingleInstanceActivation` | declarative package regis
