# P4-12 — Hardware and security services (8 components)
...
- [ ] `PermissionStatus`
  - `docs/widget-library-proposal.md:293` | `PermissionStatus`, `CameraAccess`, `MicrophoneAccess`, `PhotoLibraryPicker`, `LocationAccess`, `BiometricAuthentication`, `CredentialStor
- [ ] `CameraAccess`
  - `docs/widget-library-proposal.md:293` | `PermissionStatus`, `CameraAccess`, `MicrophoneAccess`, `PhotoLibraryPicker`, `LocationAccess`, `BiometricAuthentication`, `CredentialStor
- [ ] `MicrophoneAccess`
  - `docs/widget-library-proposal.md:293` | `PermissionStatus`, `CameraAccess`, `MicrophoneAccess`, `PhotoLibraryPicker`, `LocationAccess`, `BiometricAuthentication`, `CredentialStor
