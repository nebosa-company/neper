# P1-06 — Button family (4 components)
...
- [ ] `Button`
  ...
  - `docs/widget-library-proposal.md:118` | `Button` | normal, primary, tonal, outlined, text, destructive and floating variants |
- [ ] `IconButton`
  - `docs/widget-library-proposal.md:119` | `IconButton`, `ToggleButton` | mandatory accessible label; selected state |
- [ ] `ToggleButton`
  - `docs/widget-library-proposal.md:119` | `IconButton`, `ToggleButton` | mandatory accessible label; selected state |
  - `docs/widget-library-proposal.md:328` `ToggleButton` values;
- [ ] `Link`
  - `docs/widget-library-proposal.md:122` | `Link` | URI or application action; keyboard and visited semantics |
