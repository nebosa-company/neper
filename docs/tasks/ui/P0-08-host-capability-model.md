# P0-08 — Host capability model (3 components)

| field | value |
|---|---|
| phase | P0 — Contracts and reference theme |
| module | `e.ui.window` |
| module surface | `partial`, layer 6, deps `e.gpu`, `e.mem`, `e.os`, `e.gfx.geometry`, `e.gfx.scene` |
