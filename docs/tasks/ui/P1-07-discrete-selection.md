# P1-07 — Discrete selection (5 components)

| field | value |
|---|---|
| phase | P1 — Useful desktop and mobile core |
| module | `e.ui.control` |
| module surface | `partial`, layer 6, deps `e.gfx.geometry`, `e.gfx.paint`, `e.gfx.scene`, `e.mem`, `e.text.layout`, `e.text.shape`, `e.ui.accessibility`, `e.ui.layout`, `e.ui.style`, `e.ui.widget` |
| blocked by | `P0` |
| delivered | 0 of 5 |
...
- [ ] `Checkbox`
  - `docs/widget-library-proposal.md:123` | `Checkbox` | unchecked, checked, mixed |
  - `docs/widget-library-proposal.md:354` `Button`, `Checkbox`, `Card`, `Tabs` and most of the catalogue then become ordinary
- [ ] `Radio`
  - `docs/widget-library-proposal.md:124` | `Radio`, `RadioGroup` | group-owned single selection and arrow-key traversal |
- [ ] `RadioGroup`
  - `docs/widget-library-proposal.md:124` | `Radio`, `RadioGroup` | group-owned single selection and arrow-key traversal |
- [ ] `Switch`
  - `docs/widget-library-proposal.md:125` | `Switch` | immediate binary setting, distinct semantics from checkbox |
  - `docs/widget-library-proposal.md:216` | `WindowSwitcher` | application-owned selection among open windows/documents |
- [ ] `SegmentedControl`
  - `docs/widget-library-proposal.md:126` | `SegmentedControl` | single or multiple compact selection |
