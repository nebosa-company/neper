# P4-02 — Windows shell integration (3 components)
...
| blocked by | `P3`, `native-shell-api` |
| delivered | 0 of 3 |
...
- [ ] `JumpList`
  - `docs/widget-library-proposal.md:283` | `JumpList`, `TaskbarProgress`, `TaskbarOverlay` | publish Windows Jump List tasks/recent items and taskbar progress/overlay state without 
- [ ] `TaskbarProgress`
  - `docs/widget-library-proposal.md:283` | `JumpList`, `TaskbarProgress`, `TaskbarOverlay` | publish Windows Jump List tasks/recent items and taskbar progress/overlay state without 
- [ ] `TaskbarOverlay`
  - `docs/widget-library-proposal.md:283` | `JumpList`, `TaskbarProgress`, `TaskbarOverlay` | publish Windows Jump List tasks/recent items and taskbar progress/overlay state without 
