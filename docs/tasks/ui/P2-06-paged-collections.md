# P2-06 — Paged collections (4 components)
...
- [ ] `Carousel`
  - `docs/widget-library-proposal.md:185` | `Carousel`, `PageView` | paged collection with pointer, touch and keyboard navigation |
- [ ] `PageView`
  - `docs/widget-library-proposal.md:185` | `Carousel`, `PageView` | paged collection with pointer, touch and keyboard navigation |
- [ ] `PageIndicator`
  - `docs/widget-library-proposal.md:186` | `PageIndicator`, `Pagination` | compact page position or explicit page navigation |
- [ ] `Pagination`
  - `docs/widget-library-proposal.md:186` | `PageIndicator`, `Pagination` | compact page position or explicit page navigation |
