# P4-03 — Native notifications (3 components)
...
| blocked by | `P3`, `native-notification-api` |
| delivered | 0 of 3 |
...
- [ ] `SystemNotification`
  - `docs/widget-library-proposal.md:284` | `SystemNotification`, `NotificationActions`, `NotificationPermission` | query/request permission, publish/update/remove an OS notification
- [ ] `NotificationActions`
  - `docs/widget-library-proposal.md:284` | `SystemNotification`, `NotificationActions`, `NotificationPermission` | query/request permission, publish/update/remove an OS notification
