# M3-08 — Determinism harness: the device-reached edit case
...
- `docs/spec.md:4035` 12. Compiled modules (`.em`)
  - `docs/spec.md:4057` Contents
  - `docs/spec.md:4101` Incremental rebuilds

## Decisions to read first

- `D36` — Incremental rebuild invalidation (`docs/decisions.md:58`)
