# M6-04 — pacman P3: root-only tasks, capability approval, generated-source maps
...
> **P3, generated inputs:** root-only explicit tasks instead of dependency lifecycle hooks, argument-array execution, scratch directories, capability approval, locked tools, content-addressed outputs and v1 generated-source maps with exact hashes and spans. Install and `sync` never execute package code
