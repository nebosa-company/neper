...
- `Device`: `lib/e/gpu.e`×35, `lib/e/gfx/scene.e`×2†, `lib/e/os.windows.e`×2‡, `lib/e/ui/input.e`×2, `lib/e/os/shell.windows.e`×1‡, `lib/e/ui/app.e`×1†, `lib/e/ui/window.e`×1
- `Queue`: `lib/e/gpu.e`×35, `lib/e/concurrent/queue.e`×13, `lib/e/data/cache.e`×11, `lib/e/data/queue.e`×11, `lib/e/ui/input.e`×9, `lib/e/data/window.e`×7, `lib/e/gpu/tensor.e`×5, `lib/e/gfx/scene.e`×3†
