...
- `Device`: `lib/e/gpu.e`×35, `lib/e/gfx/scene.e`×2†, `lib/e/os.windows.e`×2‡
- `Queue`: `lib/e/gpu.e`×35, `lib/e/concurrent/queue.e`×13, `lib/e/data/queue.e`×11, `lib/e/gpu/tensor.e`×5, `src/check.e`×3‡, `lib/e/gfx/scene.e`×2†
