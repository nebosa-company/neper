...
- `lib/e`: `src/assets.e`×6, `scripts/build-bootstrap.sh`×4, `scripts/algos/agent_brief.md`×3, `scripts/render_progress.py`×3, `lib/e/os.linux.e`×2‡, `lib/e/os.windows.e`×2‡, `scripts/algos/reapply.sh`×2, `scripts/check_module_surfaces.py`×2
