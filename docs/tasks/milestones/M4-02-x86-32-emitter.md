...
- nearest existing implementation: `src/emit_x64.e`†, `src/codegen_x64.e`‡, `src/regalloc.e`, `src/object_coff.e`, `src/link_pe.e` († over 40 KB, ‡ over 120 KB — read by region)
