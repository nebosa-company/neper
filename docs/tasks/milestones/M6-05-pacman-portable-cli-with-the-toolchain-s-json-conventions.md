...
- `publish`: `lib/e/ui/accessibility.e`×6, `lib/e/os.linux.e`×3‡, `lib/e/os.windows.e`×3‡, `src/main.e`×3‡, `lib/e/math.e`×2†, `tests/conformance/tools/explain_inline.x64-linux.expected.jsonl`×2, `tests/conformance/tools/explain_inline.x64-windows.expected.jsonl`×2, `lib/e/algo/rand.e`×1
