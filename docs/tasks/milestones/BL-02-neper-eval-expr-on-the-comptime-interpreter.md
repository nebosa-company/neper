...
- `docs/spec.md:2218` 9. Compile-time parameters
  - `docs/spec.md:2310` Compile-time evaluation
  - `docs/spec.md:2382` Protocols
  - `docs/spec.md:2512` Compile-time introspection
  - `docs/spec.md:2634` Argument packs
