...
- `docs/spec.md:2170` 9. Compile-time parameters
  - `docs/spec.md:2262` Compile-time evaluation
  - `docs/spec.md:2334` Protocols
  - `docs/spec.md:2464` Compile-time introspection
  - `docs/spec.md:2586` Argument packs
