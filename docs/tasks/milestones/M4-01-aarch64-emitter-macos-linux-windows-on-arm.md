# M4-01 — aarch64 emitter (macOS, Linux, Windows on ARM)
...
- nearest existing implementation: `src/emit_x64.e`†, `src/codegen_x64.e`‡, `src/regalloc.e`, `src/object_elf.e`, `src/link_elf.e`, `src/runtime_elf_x64.s`† († over 40 KB, ‡ over 120 KB — read by region)
