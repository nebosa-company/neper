...
- `.text`: `src/check.e`×124‡, `src/tool.e`×51‡, `src/main.e`×44‡, `lib/e/ui/navigation.e`×41‡, `src/lower.e`×39‡, `lib/e/ui/control.e`×33‡, `lib/e/ui/overlay.e`×30‡, `lib/e/text/io.e`×28
...
- `.ico`: `lib/e/ui/control.e`×32‡, `lib/e/ui/navigation.e`×27‡, `lib/e/ui/collection.e`×23‡, `lib/e/ui/overlay.e`×5‡, `lib/e/fmt/brotli.e`×2‡, `lib/e/os/shell.windows.e`×1‡, `lib/e/ui/style.e`×1
- `.cur`: `src/parse.e`×201†, `src/tool.e`×43‡, `lib/e/ui/undo.e`×32, `src/lower.e`×30‡, `src/nir.e`×25†, `lib/e/gfx/scene.e`×18‡, `lib/e/ui/navigation.e`×17‡, `src/main.e`×10‡
