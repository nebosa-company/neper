...
- `.text`: `src/check.e`×121‡, `src/tool.e`×51‡, `src/main.e`×41‡, `src/lower.e`×39‡, `lib/e/text/io.e`×28, `scripts/algos/batch44.json`×25, `lib/e/ui/control.e`×21‡, `scripts/algos/decisions-pending.md`×20†
