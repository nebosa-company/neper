...
- `.ico`: `lib/e/ui/control.e`×30‡, `lib/e/ui/navigation.e`×9†, `lib/e/ui/overlay.e`×4†, `lib/e/fmt/brotli.e`×2‡, `lib/e/os/shell.windows.e`×1‡, `lib/e/ui/style.e`×1
- `.cur`: `src/parse.e`×201†, `src/tool.e`×43‡, `lib/e/ui/undo.e`×32, `src/lower.e`×30‡, `src/nir.e`×25†, `lib/e/gfx/scene.e`×18‡, `lib/e/ui/navigation.e`×11†, `src/main.e`×10‡
