...
- `.cur`: `src/parse.e`×201†, `src/tool.e`×43‡, `src/lower.e`×27‡, `src/nir.e`×25†, `src/main.e`×10‡, `lib/e/fmt/lzw.e`×6, `scripts/build-docs-pdf.py`×4, `tests/conformance/tools/explain_inline.x64-linux.expected.jsonl`×2
