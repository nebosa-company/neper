# M5-01 — Metal backend: MSL or AIR emitter plus a Metal runtime
...
> Metal backend: MSL or AIR emitter plus a Metal runtime, replacing MoltenVK as the first-tier Apple GPU path
