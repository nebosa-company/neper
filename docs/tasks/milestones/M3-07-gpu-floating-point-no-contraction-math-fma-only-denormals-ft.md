...
- `docs/spec.md:3550` 11. Build modes and safety
  - `docs/spec.md:3605` Trap protocol
  - `docs/spec.md:3663` Resources: static rules
  - `docs/spec.md:3922` Debug fills
  - `docs/spec.md:3935` Floating point
