...
- `docs/spec.md:3557` 11. Build modes and safety
  - `docs/spec.md:3612` Trap protocol
  - `docs/spec.md:3670` Resources: static rules
  - `docs/spec.md:3929` Debug fills
  - `docs/spec.md:3942` Floating point
