...
- `docs/spec.md:3551` 11. Build modes and safety
  - `docs/spec.md:3606` Trap protocol
  - `docs/spec.md:3664` Resources: static rules
  - `docs/spec.md:3923` Debug fills
  - `docs/spec.md:3936` Floating point
