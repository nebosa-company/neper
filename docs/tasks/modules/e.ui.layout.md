# e.ui.layout — 14 of 14 declarations missing

| field | value |
|---|---|
| file to create | `lib/e/ui/layout.e` |
...
- `build/windows/tests/selfhost/neper-self.exe parse-file lib/e/ui/layout.e` prints `parse file ok`.
- A fixture `tests/selfhost/fixtures/link/ui_layout/src/main.e` that prints one fixed line on success, registered in both runners.
