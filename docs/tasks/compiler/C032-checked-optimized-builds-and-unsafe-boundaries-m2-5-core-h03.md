...
- `D924` — A generic union's instance is asked what its declaration was (`docs/decisions.md:18268`)
- `D925` — `@packed` and `@align(N)` lay out as section 4 says (`docs/decisions.md:18284`)
...
- `tests/selfhost/fixtures/link/layout_packed`
