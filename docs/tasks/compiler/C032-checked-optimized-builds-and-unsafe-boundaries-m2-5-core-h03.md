...
- `unchecked`: `src/em.e`×36‡, `src/main.e`×27‡, `src/check.e`×23‡, `src/tool.e`×11‡, `scripts/render_tasks.py`×2†, `scripts/bonsai_driver.py`×1, `src/codegen_x64.e`×1‡, `tests/conformance/reject/safety_unchecked.expected.jsonl`×1
...
- `mem.cast`: `lib/e/io.e`×34, `lib/e/os.windows.e`×21‡, `lib/e/net/http.e`×19†, `lib/e/data/tree.e`×14, `lib/e/os.linux.e`×11†, `lib/e/data/map.e`×10, `lib/e/data/slot_map.e`×10, `lib/e/net/tls.e`×10†
