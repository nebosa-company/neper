...
- `mem.bitcast`: `lib/e/math.e`×26†, `lib/e/str.e`×16†, `lib/e/math/float.e`×12, `lib/e/gfx/scene.e`×7†, `lib/e/os.windows.e`×7‡, `lib/e/audio.e`×6, `lib/e/fmt/bson.e`×6, `src/check.e`×5‡
