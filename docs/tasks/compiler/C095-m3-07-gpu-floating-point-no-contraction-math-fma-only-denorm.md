# C095 — M3-07: GPU floating point: no contraction, math.fma only, denormals, ftz

| field | value |
|---|---|
| category | compiler / Back end |
| score | 0.00 of 1 |
| queue position | 34 of 55 (only position 1 is eligible for the next session; see README) |
