# C094 — M3-06: device-callable inference into the kernel-owning module's .em

| field | value |
|---|---|
| category | compiler / Back end |
| score | 0.00 of 1 |
| queue position | 31 of 53 (only position 1 is eligible for the next session; see README) |
