...
- `D946` — An image lays out only the globals its code reaches (`docs/decisions.md:18950`)
- `D947` — H25's persistent-session workflow: a query in tens of milliseconds, nothing retained (`docs/decisions.md:18975`)
- `D948` — H25's context/repair workflow: what an agent is handed, and repairs by the compiler's own fixes (`docs/decisions.md:19007`)
...
- `benchmarks/baseline/session.py`: `benchmarks/baseline/session.py`×1
