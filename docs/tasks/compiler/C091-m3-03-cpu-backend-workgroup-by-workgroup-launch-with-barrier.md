...
| score | 0.65 of 1 |
| queue position | 21 of 46 (only position 1 is eligible for the next session; see README) |
...
- `Stack`: `src/lower.e`×35‡, `lib/e/ui/undo.e`×21, `lib/e/data/stack.e`×11, `lib/e/concurrent/stack.e`×10, `src/codegen_x64.e`×9‡, `lib/e/ui/widget.e`×8‡, `src/regalloc.e`×8, `lib/e/data/window.e`×7
