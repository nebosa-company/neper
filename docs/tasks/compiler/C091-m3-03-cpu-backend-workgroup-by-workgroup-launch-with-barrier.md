...
- `Stack`: `src/lower.e`×35‡, `lib/e/ui/undo.e`×21, `lib/e/data/stack.e`×11, `src/codegen_x64.e`×9‡, `lib/e/data/window.e`×7, `lib/e/ui/widget.e`×7‡, `src/regalloc.e`×7, `src/nir.e`×4†
