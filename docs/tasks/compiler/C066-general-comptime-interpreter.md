...
| score | 0.85 of 1 |
| queue position | 18 of 49 (only position 1 is eligible for the next session; see README) |
...
- `.len`: `src/main.e`×535‡, `src/check.e`×326‡, `src/tool.e`×309‡, `src/em.e`×158‡, `lib/e/fmt/json.e`×154†, `lib/e/algo/sketch.e`×139†, `lib/e/os.linux.e`×139‡, `lib/e/net/tls.e`×116†
