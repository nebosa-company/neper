...
- `.len`: `src/main.e`×542‡, `src/check.e`×333‡, `src/tool.e`×309‡, `src/em.e`×168‡, `lib/e/fmt/json.e`×154†, `lib/e/os.linux.e`×145‡, `lib/e/algo/sketch.e`×139†, `lib/e/ui/control.e`×126‡
