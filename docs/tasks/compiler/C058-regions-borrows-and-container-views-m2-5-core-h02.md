...
| score | 0.99 of 1 |
| queue position | 14 of 47 (only position 1 is eligible for the next session; see README) |
...
- `.len`: `src/main.e`×537‡, `src/check.e`×331‡, `src/tool.e`×309‡, `src/em.e`×168‡, `lib/e/fmt/json.e`×154†, `lib/e/os.linux.e`×145‡, `lib/e/algo/sketch.e`×139†, `lib/e/net/tls.e`×116†
