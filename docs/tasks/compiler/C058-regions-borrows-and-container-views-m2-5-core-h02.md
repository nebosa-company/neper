...
| score | 0.99 of 1 |
| queue position | 17 of 47 (only position 1 is eligible for the next session; see README) |
...
- `.len`: `src/main.e`×532‡, `src/check.e`×317‡, `src/tool.e`×308‡, `src/em.e`×152‡, `lib/e/fmt/json.e`×131†, `lib/e/net/tls.e`×116†, `lib/e/os.linux.e`×106†, `lib/e/str.e`×95†
