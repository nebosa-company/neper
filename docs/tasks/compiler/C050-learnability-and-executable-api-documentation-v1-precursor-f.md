...
| score | 0.76 of 1 |
| queue position | 7 of 45 (only position 1 is eligible for the next session; see README) |
...
- `unavailable`: `lib/e/crypto/sign.e`×2†, `src/tool.e`×2‡, `lib/e/crypto/kx.e`×1, `lib/e/ui/navigation.e`×1‡, `lib/e/ui/overlay.e`×1‡, `tests/conformance/reject/safety_thread_dynamic_array_element_context.e`×1, `tests/conformance/tools/batch.x64-linux.expected.jsonl`×1, `tests/conformance/tools/batch.x64-windows.expected.jsonl`×1
