...
- `unavailable`: `src/tool.e`×2‡, `lib/e/ui/overlay.e`×1†, `tests/conformance/reject/safety_thread_dynamic_array_element_context.e`×1, `tests/conformance/tools/batch.x64-linux.expected.jsonl`×1, `tests/conformance/tools/batch.x64-windows.expected.jsonl`×1, `tests/conformance/tools/catalog_unavailable.expected.jsonl`×1
