...
| score | 0.40 of 1 |
| queue position | 25 of 48 (only position 1 is eligible for the next session; see README) |
...
- `Unsupported`: `src/codegen_x64.e`×106‡, `src/check.e`×72‡, `src/lower.e`×55‡, `lib/e/os/shell.linux.e`×50, `lib/e/os.linux.e`×27‡, `lib/e/os.windows.e`×18‡, `lib/e/crypto/x509.e`×17, `lib/e/fmt/parquet.e`×15†
