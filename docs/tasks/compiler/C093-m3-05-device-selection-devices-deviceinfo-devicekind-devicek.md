...
- `Unsupported`: `src/codegen_x64.e`×104‡, `src/check.e`×72‡, `src/lower.e`×55‡, `lib/e/crypto/x509.e`×17, `lib/e/net/tls.e`×14†, `lib/e/fmt/jpeg.e`×12†, `lib/e/os.windows.e`×10‡, `lib/e/net/http.e`×9†
