...
- `Unsupported`: `src/codegen_x64.e`×104‡, `src/check.e`×72‡, `src/lower.e`×55‡, `lib/e/os/shell.linux.e`×50, `lib/e/os.linux.e`×25‡, `lib/e/crypto/x509.e`×17, `lib/e/os.windows.e`×16‡, `lib/e/net/tls.e`×14†
