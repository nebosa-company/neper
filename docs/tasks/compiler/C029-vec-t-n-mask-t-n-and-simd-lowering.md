...
- `mem.alloc`: `src/main.e`×243‡, `src/tool.e`×79‡, `src/em_link.e`×49†, `lib/e/fmt/json.e`×26†, `src/check.e`×24‡, `lib/e/os.windows.e`×23‡, `lib/e/algo/graph.e`×22, `lib/e/os.linux.e`×18†
