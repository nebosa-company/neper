...
| score | 0.80 of 1 |
| queue position | 25 of 49 (only position 1 is eligible for the next session; see README) |
...
- `e.gpu`: `src/check.e`×6‡, `src/lower.e`×5‡, `lib/e/gfx/scene.e`×2†, `src/resolve.e`×2†, `lib/e/gpu.e`×1, `lib/e/gpu/tensor.e`×1, `lib/e/ui/testing.e`×1, `lib/e/ui/widget.e`×1†
...
- `Image`: `lib/e/gfx/image.e`×10, `lib/e/gfx/scene.e`×10†, `lib/e/gpu.e`×9, `lib/e/ui/widget.e`×9†, `scripts/build-docs-pdf.py`×7, `lib/e/fmt/png.e`×6, `lib/e/fmt/webp.e`×5†, `lib/e/fmt/jpeg.e`×3†
- `open_target`: `lib/e/ui/window.e`×2, `lib/e/gpu.e`×1, `lib/e/ui/testing.e`×1
- `presented`: `lib/e/gpu.e`×4, `lib/e/ui/testing.e`×2, `lib/e/ui/window.e`×2, `lib/e/gfx/scene.e`×1†, `lib/e/os.linux.e`×1‡, `lib/e/os.windows.e`×1‡, `src/check.e`×1‡
- `resize`: `lib/e/ui/window.e`×2, `lib/e/gpu.e`×1
