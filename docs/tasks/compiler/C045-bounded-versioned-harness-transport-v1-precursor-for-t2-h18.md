...
- `progress`: `scripts/render_progress.py`×7, `src/main.e`×7‡, `lib/e/io.e`×6, `src/lower.e`×5‡, `src/nir.e`×4†, `lib/e/async/io.e`×2, `benchmarks/protocol_strategies/measure.py`×1, `lib/e/fs.e`×1
