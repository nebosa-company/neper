...
- `overlay`: `lib/e/ui/widget.e`×54‡, `src/main.e`×40‡, `src/graph.e`×13†, `lib/e/ui/control.e`×11‡, `lib/e/ui/overlay.e`×10†, `lib/e/ui/navigation.e`×8†, `src/assets.e`×7, `lib/e/ui/testing.e`×5
