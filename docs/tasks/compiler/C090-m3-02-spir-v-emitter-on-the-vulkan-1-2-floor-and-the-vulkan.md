# C090 — M3-02: SPIR-V emitter on the Vulkan 1.2 floor and the Vulkan compute runtime

| field | value |
|---|---|
| category | compiler / Back end |
| score | 0.00 of 1 |
| queue position | 23 of 49 (only position 1 is eligible for the next session; see README) |
