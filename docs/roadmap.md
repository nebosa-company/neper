...
payloads, positional values and bare PascalCase members. Type subtrees inside local
declarations, switch arms and recursively parsed control-flow bodies remain the
