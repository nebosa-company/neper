<!-- generated by scripts/render_card.py from docs/grammar.ebnf revision 3, language 0.1, tool 0.1.0; content sha256 67986a4467124943c8f4fbe0cf4f9813330ffe719291ebc5837a03b7b53cd08e. Do not edit: edit docs/llm-neper-card.src.md and re-render. -->
...
- `E-LINK-*`: 2 codes (1 verified, 1 present); `E-LINK-9999` is the catch-all; `E-LINK-9999` present
...
- `E-TOOL-*`: 4 codes (2 verified, 2 present); `E-TOOL-9999` is the catch-all; `E-TOOL-0003` present, `E-TOOL-9999` present
