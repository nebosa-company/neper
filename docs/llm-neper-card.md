<!-- generated by scripts/render_card.py from docs/grammar.ebnf revision 3, language 0.1, tool 0.1.0; content sha256 ca9e5f24e88eb8c3e4e85855e0d031362215a48d23c3bddb490a78f6d11d1fa9. Do not edit: edit docs/llm-neper-card.src.md and re-render. -->
...
- `E-SAFETY-*`: 17 codes (17 verified); `E-SAFETY-9999` is the catch-all
- `E-SYNTAX-*`: 2 codes (2 verified); `E-SYNTAX-9999` is the catch-all
- `E-TEST-*`: 1 codes (1 verified); `E-TEST-9999` is the catch-all
- `E-TOOL-*`: 3 codes (2 verified, 1 present); `E-TOOL-9999` is the catch-all; `E-TOOL-9999` present
