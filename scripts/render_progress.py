...
compiler = {
 "Front end and language": [
  ...
  ("Scoped concurrency and shared-state contracts (M2.5 H04)", 0.25, "The join obligation is H01's (a `Thread` is owed at every exit); a thread started over this frame's storage cannot be detached, handed on, returned or stored past it (D357, E-SAFETY-0015). Not yet: the design, shared mutable aliases, lock capabilities and guards, worker arena sharing, partial spawn failure, schedule perturbation as evidence"),
