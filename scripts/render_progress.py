...
compiler = {
 "Front end and language": [
  ...
  ("Resource ownership and cleanup (M2.5 H01)", 0.5, "The seeded handles are affine and obligated, `own` parameters transfer, every exit audits, `defer` reserves, an untested acquisition is unchecked, arms join and loops keep outer resources (D345): seven E-SAFETY codes pinned by conformance fixtures, both suites on every fixture and library, the compiler's own leaks found and fixed. Not yet: aggregates holding resources, representation opacity, copies through generics, borrow-then-move, declared `resource` types, `os.dup`, `mem.Arena`"),
