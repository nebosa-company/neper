...
compiler = {
 "Front end and language": [
  ...
  ("Supplied format (rule 4)", 0.95, "link/str_format, link/io_printf expand scalars, str, bool and err; slices and arrays recurse an element at a time as `[a, b]`, nesting included (D189); enums and a type's own format are what remains"),
