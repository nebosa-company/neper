...
compiler = {
 "Front end and language": [
  ...
  ("Scalar floating point f32 / f64", 1, "link/float_scalar; f16 / bf16 still unlowered. link/math_exact pins `math.sqrt` as the one float intrinsic -- `sqrtss`/`sqrtsd` behind a NIR opcode of its own, correctly rounded and checked by its bits (D146)"),
