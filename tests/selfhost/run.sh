...
for conformance_case in 'reject regions_pointer_chain 1' 'reject regions_arena_alias 1' 'reject safety_thread_context_alias 1' 'accept regions_deferred_after_alloc 0' 'reject regions_deferred_escape 1' 'reject regions_arena_pointer_copy 1' 'reject regions_mark_copy 1' 'reject regions_accessor_alias 1' 'reject safety_thread_slice_context 1' 'reject regions_deferred_slice_escape 1'; do
    set -- $conformance_case
    conformance_status=0
